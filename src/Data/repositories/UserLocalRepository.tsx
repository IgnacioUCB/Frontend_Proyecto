...
export class UserLocalRepositoryImpl implements UserLocalRepository {
    ...
    async saveProduct(products: Product[]): Promise<void> {
        const { save, getItem } = LocalStorage();
        await save('product', JSON.stringify(products));
        

        console.log('desde use case Carrito actualizado: ', await getItem('product'))
